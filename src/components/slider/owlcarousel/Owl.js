        ...
        <OwlCarousel className="owl-theme owl-roof" {...options}>
            ...
            <div className="item owl-slider">
                <div className="owlCarouselTemp">
                    <img src={o4} className="owlCarouselImage" alt="Kayseri Güzellik Merkezi" loading="lazy" title="Kayseri Epilasyon"></img>
            ...
            <div className="item owl-slider">
                <div className="owlCarouselTemp">
                    <img src={o3} className="owlCarouselImage" alt="Kayseri Güzellik Merkezi" loading="lazy" title="Kayseri Epilasyon"></img>
            ...
            <div className="item owl-slider">
                <div className="owlCarouselTemp">
                    <img src={o1} className="owlCarouselImage" alt="Kayseri Güzellik Merkezi" loading="lazy" title="Kayseri Lazer Epilasyon"></img>
            ...
            <div className="item owl-slider">
                <div className="owlCarouselTemp">
                    <img src={o5} className="owlCarouselImage" alt="Kayseri Güzellik Merkezi" loading="lazy" title="Kayseri Lazer Epilasyon"></img>
            ...
            <div className="item owl-slider">
                <div className="owlCarouselTemp">
                    <img src={o6} className="owlCarouselImage" alt="Kayseri Güzellik Merkezi" loading="lazy" title="Kayseri Güzellik Merkezi"></img>
            ...
            <div className="item owl-slider">
                <div className="owlCarouselTemp">
                    <img src={o2} className="owlCarouselImage" alt="Kayseri Güzellik Merkezi" loading="lazy" title="Kayseri Güzellik Merkezi"></img>
