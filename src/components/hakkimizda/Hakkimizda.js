    ...
    <div className="col-12">
      ...
      >
        ...
        <div className="card-body col-12" style={{ padding: "3rem" }}>
          ...
          <p class="hizmetyazi">
            Kayseri Lavinya Golden Güzellik Merkezi olarak Lazer Epilasyon, G5
            ...
            müşterimize hizmet verebilmekteyiz.
                ...
                <p className="instaLink" style={{textAlign:"center",color:"gray"}}>Detaylı güncel fotoğraf ve videolar için <a className="instagram"  href="https://www.instagram.com/lavinyagoldenkayseri/" target="_blank">Kayseri Lavinya Golden Güzellik Merkezi</a> instagram profilimizi ziyaret edebilirsiniz. </p>
